/*
	Updated September 2015 by PlusIce to add end of map vote
	Deathmatch
...
////////// Added by lev ///////////////
	maps\mp\gametypes\_lev::Callback_StartGameType();
///////////////////////////////////////
...
Callback_PlayerConnect()
{
	...
	if(isDefined(self.pers["team"]) && self.pers["team"] != "spectator")
	{
		...
		{
			self notify("end_saveposition_threads"); //lev
			spawnSpectator();
...
///// Added by lev ////////
	self maps\mp\gametypes\_lev::PlayerDisconnect();
///////////////////////////
...
/// Leveller \\\
Callback_PlayerDamage_dm(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc)
{
	if(self.sessionteam == "spectator")
		return;
...
///////////////////////////
	...
	if(!(iDFlags & level.iDFLAGS_NO_PROTECTION))
	{
		if(isPlayer(eAttacker) && (self != eAttacker))
		{
			...
			else if(level.friendlyfire == "1" && !isdefined(eAttacker.pers["lev_teamkiller"]))
			{
				// Make sure at least one point of damage is done
				if(iDamage < 1)
					iDamage = 1;
			...
			else if(level.friendlyfire == "2" || isdefined(eAttacker.pers["lev_teamkiller"]))
			{
...
/////////// Added by lev ///////////
	self thread maps\mp\gametypes\_lev::PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc);
////////////////////////////////////
	...
	if(isPlayer(attacker))
	{
		...
		else
		{
			...
			attacker.score++;
			/////////// Added by lev ///////////
			if (getcvar("scr_lev_AntiKill")) attacker maps\mp\gametypes\_lev::Antikill();
			/////////// Added by lev ///////////
...
////////////// Added by lev /////////////////
	self maps\mp\gametypes\_lev::spawnPlayer();
/////////////////////////////////////////////
}
