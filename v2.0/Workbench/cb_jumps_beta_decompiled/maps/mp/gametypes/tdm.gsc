/*
	Updated on September 2015 by PlusIce to add in End of Map Vote.
	Team Deathmatch
	...
	if(isPlayer(attacker))
	{
		...
		else
		{
			...
			if(self.pers["team"] == attacker.pers["team"]) // killed by a friendly
			{
				attacker.score--;
			/////////// Added by lev ///////////
			if (getcvar("scr_lev_AntiKill"))
				{
				attacker maps\mp\gametypes\_lev::Antikill();
				}
			else
				{
				attacker maps\mp\gametypes\_lev::teamkill();
				}
			/////////// Added by lev ///////////
			}
			else
